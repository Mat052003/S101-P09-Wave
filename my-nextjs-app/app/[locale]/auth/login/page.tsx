...
export default function LoginPage() {
  ...
  const targetAfterLogin =
    callbackUrl && callbackUrl.startsWith("/") ? callbackUrl : `/${locale}/hotels`;
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-md">
          <section className="panel rounded-[2rem] p-6 md:p-8">
            <div className="mb-8">
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#284B63]">{t("title")}</p>
              ...
              <p className="mt-2 text-sm text-[#284B63]/80">
                {step === "credentials" ? t("subtitle") : t("verifyIdentity")}
              </p>
            </div>
            ...
            {step === "credentials" ? (
              <>
                ...
                <div className="flex items-center gap-3 my-6">
                  ...
                  <span className="text-xs text-[#284B63]/80 font-medium">{t("orWithEmail")}</span>
                  <div className="flex-1 h-px bg-[#153243]/15" />
                </div>

...
export default function LoginPage() {
  ...
  const targetAfterLogin = callbackUrl && callbackUrl.startsWith("/") ? callbackUrl : "/hotels";
        ...
        <div className="bg-[#FAF6F0]/97 backdrop-blur-xl rounded-3xl shadow-2xl shadow-[#0B1F2D]/40 p-8 border border-white/30">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-[#0B1F2D]/55 mt-2">
              {step === "credentials" ? "Inicia sesión en tu cuenta" : `Código enviado a ${email}`}
            </p>
          </div>
          ...
          {step === "credentials" ? (
            <>
              ...
              <div className="flex items-center gap-3 my-5">
                ...
                <span className="text-xs text-[#0B1F2D]/40 font-medium">o con email</span>
                <div className="flex-1 h-px bg-[#0B1F2D]/10" />
              </div>
              ...
              <div className="mt-4 text-center">
                <Link href="/auth/forgot-password"
                  className="text-xs text-[#0B1F2D]/45 hover:text-[#C9A87C] transition-colors">
